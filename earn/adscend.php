...
<head>
    ...
    <title>Adscend Media</title>
    <div id="menu">
        <nav>
            <ul>
                <li><a href="../index.php">CSGO-Boonie</a></li>
                <li><a href="earn.php">Earn Coins</a></li>
                <li><a href="../cash-out/cashout.php">Cash Ouat</a></li>
...
<body>
  <center><iframe src="https://asmwall.com/adwall/publisher/113622/profile/12830?subid1=LAn" frameborder="0"
    width="728" height="2400"></iframe><center>
 </center>
</body>
</html>